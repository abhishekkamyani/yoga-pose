...
function Home() {
  ...
  return (
    <section className="container-sm h-screen mx-auto">
        ...
        <div className="py-10 w-3/4">
          {value === "Classifier" ? (
            <>
              ...
              <LinkButton title="CNN Classifier Module" to="module/classifier" />
            </>
