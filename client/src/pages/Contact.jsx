  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await toast.promise(
        axios.post("https://formspree.io/f/xrgndpbg", data),
        {
              ...
              <ul className="mb-6 md:mb-0">
                ...
                <li className="flex">
                  ...
                  <div className="ml-4 mb-4">
                    ...
                    <p className="text-gray-600 dark:text-slate-400">
                      Mobile: +92 (307) 761-6717
                    </p>
                    <p className="text-gray-600 dark:text-slate-400">
                      Mail: sartajmalik03776@gmail.com
                    </p>
                  </div>
                </li>
                <li className="flex">
                ...
                <div className="mb-6">
                  ...
                  <div className="mx-0 mb-1 sm:mb-4">
                    ...
                    <textarea
                      ...
                      className="mb-2 w-full rounded-md border border-gray-400 py-2 pl-2 pr-4 shadow-md dark:bg-dark-main dark:text-gray-300 sm:mb-0"
                      value={data.message}
                      onChange={handleChange}
                    />
                  </div>
